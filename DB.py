...
from DB_project2 import add_new_admin
from DB_project2 import add_comment
from DB_project2 import show_product_card

# print(show_product_card('Fix Dark'))

# print(show_comments('food'))
# print(add_new_admin(1924589846, 'Oleg', 1))
# correct_goods('Апельсин', ['2', 'Мандарин', 'really tasty Мандарин', 9.00, 3, 515, 'orange.jpg'], 1111)
# correct_goods('Orange_', ['2', 'Mirinda', 'really tasty Fanta', 9.00, 3, 515, 'Mirinda.jpg'], 111)
# print(delete_goods('Апельсин'))


# add_comment('food', 1924589846, 'comment1')
# add_comment('food', 1924589846, 'comment2')
# add_comment('food', 1924589846, 'comment3')

# add_comment('Fix Dark', 111, 'this is fucking boolshit')
# add_comment('Fix Dark', 222, 'i hate this beer')
# add_comment('Beer OuroPretana', 222, 'this beer is too cool!')
# add_comment('Пицца на черном тесте', 111, 'The best pizza i ever had.')
# add_comment('Черная паста с креветками', 111, 'really delicious')


# add_new_admin(1924589846, 'Oleg', 1)
# add_new_admin(123, 'Саша', 0)
# add_new_admin(222, 'Петя', 1)
# add_new_admin(333, 'Зина', 0)
# add_new_admin(4, 'Гриша', 1)


# registrator([11111111111, 'Tom', '+385299379992', '12.01.1993'])
